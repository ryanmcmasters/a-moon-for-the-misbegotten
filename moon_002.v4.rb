...
live_loop :chords do
  ...
  rrand_i(2,6).times do
    ...
    midi p + 50 + [0,12,24].choose, sustain: s.choose*2, channel: 1, port: port
    sleep s.choose
...
live_loop :chords2 do
  ...
  rrand_i(2,6).times do
    ...
    midi p + 50 + [0,12,24].choose, sustain: s.choose*2, channel: 2, port: port
    sleep s.choose
...
live_loop :chords3 do
  ...
  rrand_i(2,6).times do
    ...
    midi p + 50 + [0,12].choose, sustain: s.choose*2, channel: 3, port: port
    sleep s.choose
